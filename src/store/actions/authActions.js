...
const api = axios.create({
  baseURL: 'https://printer-e-commerce.onrender.com',
  headers: {
...
export const login = (credentials) => async (dispatch) => {
  try {
    const res = await axios.post('https://printer-e-commerce.onrender.com/api/users/login', credentials);
...
export const register = (userData) => async (dispatch) => {
  try {
    const res = await axios.post('https://printer-e-commerce.onrender.com/api/users/register', userData);
